...
namespace Allatkert
{
    internal class Allatkert
    {
        ...
        {
            viziAllats.Add(new ViziAllat(7, "Delfin", "Nemo", 120, "Hím"));
            hidegAllats.Add(new HidegAllat(8, "Pingvin", "Luna", 30, "Nőstény"));
            mediterranAllats.Add(new MediterranAllat(5, "Teknős", "Rafi", 15, "Hím"));
            melegAllats.Add(new MelegAllat(4, "Oroszlán", "Simba", 190, "Hím"));
            tropusiAllats.Add(new TropusiAlllat(6, "Papagáj", "Coco", 2, "Nőstény"));
        }
